    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_permissions', models.ManyToManyField(blank=True, related_name='core_user_set', related_query_name='user', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.BooleanField(default=False)),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='client_trips', to='core.user')),
                ('driver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='driver_trips', to='core.user')),
            ],
            options={
                'verbose_name': 'Trip',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_agency', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.agency')),
                ('id_vehicle', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.vehicle')),
            ],
            bases=('core.profile',),
        ),
    ]
